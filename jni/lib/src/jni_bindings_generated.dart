...
/// (You can try to initialize a JniBindings with a different Dylib like libjvm.so or DynamicLibrary.process
///   if you really want to access these functions.)
/// Regenerate bindings with `dart run ffigen --config ffigen_jni.yaml`.
///
class JniBindings {
