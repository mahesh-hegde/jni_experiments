...
var resultConverters = {
  ...
  "Object": (String resultVar) =>
      "return JniObject._(_env, $resultVar, nullptr)",
...
var invokeResultConverters = {
  "String": (String resultVar) => "final str = env.asDartString($resultVar);"
      ...
      "return str",
  "Object": (String resultVar) => "return JniObject._(env, $resultVar, nullptr)",
  "Boolean": (String resultVar) => "return $resultVar != 0",
};
...
void main(List<String> args) {
  ...
  var outPutPaths = {
    sInst: join(outputDir, "jniobject_methods_generated.dart"),
    sStatic: join(outputDir, "jniclass_methods_generated.dart"),
